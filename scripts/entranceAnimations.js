...
const entranceAnim = () => {
    ...
    entranceAnimationTL.from(".header__icon .face-front, .face-right, .face-top", 0.5, {
        fill: "transparent",
        opacity: 0,
        stagger: 0.05,
    });

    entranceAnimationTL.from(".header__title",
        0.5, {
            y: -100,
            opacity: 1,
    ...
    entranceAnimationTL.from(".cubic__face",
        1, {
    ...
    entranceAnimationTL.from(".action-bar",
        0.5, {
            y: 1000,
            opacity: 1,
            overflox: 'hidden',
